...
const Footer: React.FC = () => (
  <footer className="w-full bg-black p-5 text-white lg:py-20">
    <div className="container mx-auto w-full">
      <div className="grid grid-cols-12">
        <div className="relative col-span-12 lg:col-span-4">
          ...
          <div className="absolute bottom-0 hidden items-end gap-5 lg:flex">
            <h5 className="-mb-1 text-xs text-grey40">Powered by </h5>
            <svg
              width="178"
              height="33"
              viewBox="0 0 178 33"
        ...
        <div className="col-span-12 flex justify-end text-xs lg:col-span-8 lg:text-sm">
